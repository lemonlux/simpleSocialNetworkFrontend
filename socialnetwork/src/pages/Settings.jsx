...
import { ButtonPrimary, FlexDir, Form, H1Form, H2Form, H3Feed, LabelAndInput, Loading, RadioInput } from "../components";
    ...
    <>
      ...
      { isLoading ? <Loading/> : (
        <>
            ...
            />
            <label htmlFor="private" className="labelRadio" onClick={() => setPrivacy("private")}>
              Private
            </label>
            <input
              type="radio"
              ...
              {...register("privacy", { required: true })}
            />
            <label htmlFor="public" className="labelRadio" onClick={() => setPrivacy("public")}>
             Public
            </label>
                  </RadioInput>
                </LabelAndInput>
                  ...
                  <FlexDir>
                    <RadioInput minW={"68%"}>
                      ...
                      <input
                        ...
                        {...register("gender")}
                      />
                      <label htmlFor="other" onClick={() => setGender("nonbinary")}>
                        Other
                      </label>
                    </RadioInput>
                  </FlexDir>
